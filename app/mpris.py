...
def mpris_thread_func():
    ...
    class YTMusicMPRIS(dbus.service.Object):
        def __init__(self, bus):
            name = dbus.service.BusName("org.mpris.MediaPlayer2.magnavox2000", bus)
            ...
            if interface == PLAYER_IFACE:
                ...
                if prop == "Metadata":
                    return dbus.Dictionary({
                        ...
                        "xesam:title": state.current_title or "Magnavox 2000",
                    }, signature="sv")
            if interface == MPRIS_IFACE:
                if prop == "Identity":
                    return "Magnavox 2000 Player"
                if prop == "CanQuit":
                    return False
                if prop == "CanRaise":
                    return False
